          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <form id="profile-form" action="<?php echo e(route('users.view-profile')); ?>"  style="display: none;">
                ...
                <form id="password-form" action="<?php echo e(route('users.edit-password')); ?>"  style="display: none;">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('bookings.index')); ?>">Booking Request</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('booking-history')); ?>">Booking History</a>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('maps')); ?>">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('inquiries.create')); ?>"">Inquiry Form</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('inquiry_history')); ?>">Inquiry History</a>
                  </li>
                </ul>
              </div>
            </li>
...
<?php /**PATH D:\carservicemanagementsystem\resources\views/layouts/user.blade.php ENDPATH**/ ?>