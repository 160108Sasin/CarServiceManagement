                        ...
                        <?php $__currentLoopData = $booking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                               ...
                               <td>
                                   ...
                                   <a href="<?php echo e(route('complete_view', $bookings->id)); ?>" class="btn btn-info btn-sm">
                                        Take Action
                                    </a>
                               </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\carservicemanagementsystem\resources\views/service/complete_service.blade.php ENDPATH**/ ?>