            ...
            <div class="card">
                ...
                <form method="POST" action="{{route('bookings.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="vehicle_brand" type="text" class="form-control @error('vehicle_brand') is-invalid @enderror" name="vehicle_brand"  required autocomplete="vehicle_brand" autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="vehicle_name" type="text" class="form-control @error('vehicle_name') is-invalid @enderror" name="vehicle_name"  required autocomplete="vehicle_name" autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="vehicle_number" type="number" class="form-control @error('vehicle_number') is-invalid @enderror" name="vehicle_number"  required autocomplete="vehicle_number" autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                    <select id="service_type" onclick="runfunction()" name="service_type" class="form-control @error('service_date') is-invalid @enderror" >
                        ...
                        <div  class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select id="advance" name="mechanic_id" class="form-control @error('service_date') is-invalid @enderror" required>
                                       <option> </option>
                                        @if($mechanic->count() > 0)
                               ...
                               <select id="basic" name="mechanic_id" class="form-control @error('service_date') is-invalid @enderror" required>
                                <option> </option>
                                 @if($mechanic->count() > 0)
                                 @foreach($mechanic as $mechanics)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select id="service_time" name="service_time" class="form-control @error('service_date') is-invalid @enderror" required>
                                            <option value="0"> </option>
